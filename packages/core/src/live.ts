...
export const officialSourceRegistry: Source[] = [
  ...
  { id: "education-scholarships", name: "AICTE Scholarship Schemes", publisher: "All India Council for Technical Education", canonicalUrl: "https://www.aicte-india.org/bureaus/rifd/Scholarship-Schemes", audience: ["student"], refreshHours: 24 },
