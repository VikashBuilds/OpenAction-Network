...
export const officialSourceRegistry: Source[] = [
  ...
  { id: "education-scholarships", name: "Press Information Bureau Public Releases", publisher: "Press Information Bureau, Government of India", canonicalUrl: "https://www.pib.gov.in/AllRel.aspx", audience: ["student", "citizen", "business"], refreshHours: 12 },
